...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>Dashboard <small>Edit Video</small></h1>
    ...
    <section class="content">
        <div class="row">
            <form role="form" method="POST" id="create-user-form" action="{{ route('videos.update.video', $video->id) }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row {{ $errors->has('title')?'has-error':'' }}">
                                                ...
                                                <div class="col-md-6">
                                                    <input id="" type="text" class="form-control" name="title" value="{{ $video->title }}" placeholder="Enter Title " required>
                                            ...
                                            <div class="form-group row {{ $errors->has('description')?'has-error':'' }}">
                                                ...
                                                <div class="col-md-6">
                                                    <input id="" type="text" class="form-control" name="description" value="{{ $video->description }}" placeholder="Enter Description" required>
                                            ...
                                            <div class="form-group row {{ $errors->has('video')?'has-error':'' }}">
                                                ...
                                                <div class="col-md-6">
                                                    <input id="" type="file" class="form-control" name="video" value="{{ $video->video }}" placeholder="Upload video">
                                            ...
                                            <div class="form-group row {{ $errors->has('thumb_img')?'has-error':'' }}">
                                                ...
                                                <div class="col-md-6">
                                                    <input id="" type="file" class="form-control" name="thumb_img" value="{{ $video->thumbnail_image }}" placeholder="Upload Thumbnail Image">
                                            ...
                                            <div class="form-group row {{ $errors->has('duration')?'has-error':'' }}">
                                                ...
                                                <div class="col-md-6">
                                                    <input id="" type="text" class="form-control" name="duration" value="{{ $video->duration  }}" placeholder="Enter Video Duration" required>
