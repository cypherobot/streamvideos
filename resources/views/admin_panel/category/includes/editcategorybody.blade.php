...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>Dashboard <small>Edit Category</small></h1>
    ...
    <section class="content">
        <div class="row">
            <form role="form" method="POST" id="create-user-form" action="{{ route('categories.update.category', $category->id) }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row {{ $errors->has('category')?'has-error':'' }}">
                                                ...
                                                <div class="col-md-6">
                                                    <input id="" type="text" class="form-control" name="category" value="{{ $category->category }}" placeholder="Enter Category Name" required>
